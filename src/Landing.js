		...
		projects.map(project => 
			<li key={project.path}>
				<Link
					to={project.path}
				>
					<div className="flex flex-col items-center border border-teal-100 shadow rounded-sm bg-teal-100 transition hover:shadow-md hover:bg-teal-200 hover:border-teal-200">
						<img className="h-full w-full" src={`${screenshotUrl}${project.path}&type=png`} alt="project-thumbnail"/>
