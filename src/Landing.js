	...
	return (
		<main className="m-12">
			...
			<ul className="flex flex-wrap gap-5 my-8">
				...
				<Link className="bg-teal-100 py-4 px-6 text-center rounded-full cursor-pointer transition hover:bg-teal-200 hover:shadow-sm" to="investment-calculator">💸 Investment Calculator</Link>
			</ul>
